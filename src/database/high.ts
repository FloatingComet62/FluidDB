...
function deleteOcean(oceanName: string): HighResponse {
    const { success, message } = low.getData()
    if (!success) return { success: false, message, code: 2 }
    if (!message[oceanName]) return { success: false, message: `Ocean ${oceanName} does not exist`, code: 1 }
    delete message[oceanName]
...
function deleteSea(oceanName: string, seaName: string): HighResponse {
    const { success, message } = low.getData()
    if (!success) return { success: false, message, code: 2 }
    if (!message[oceanName]) return { success: false, message: `Ocean ${oceanName} does not exist`, code: 1 }
    if (!message[oceanName][seaName]) return { success: false, message: `Sea ${seaName} does not exist`, code: 1 }
    delete message[oceanName][seaName]
...
function deleteRiver(oceanName: string, seaName: string, riverName: string): HighResponse {
    const { success, message } = low.getData()
    if (!success) return { success: false, message, code: 2 }
    if (!message[oceanName]) return { success: false, message: `Ocean ${oceanName} does not exist`, code: 1 }
    if (!message[oceanName][seaName]) return { success: false, message: `Sea ${seaName} does not exist`, code: 1 }
    if (!message[oceanName][seaName][riverName]) return { success: false, message: `River ${riverName} does not exist`, code: 1 }
    delete message[oceanName][seaName][riverName]
...
function updateRiver(oceanName: string, seaName: string, riverName: string, value: string): HighResponse {
    const { success, message } = low.getData()
    if (!success) return { success: false, message, code: 2 }
    if (!message[oceanName]) return { success: false, message: `Ocean ${oceanName} does not exist`, code: 1 }
    if (!message[oceanName][seaName]) return { success: false, message: `Sea ${seaName} does not exist`, code: 1 }
